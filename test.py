...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--model", type=str, default="pspnet", help="Model Name"  # Need to be fixed
    )
    parser.add_argument(
        "--batch_size",
        type=int,
        default=155,  # Need to be fixed
        help="The batch size to load the data",
    )
    parser.add_argument("--data", type=str, default="complete", help="Label data type.")
    parser.add_argument(
        "--img_root",
        type=str,
