...
############################## Implementation of Dice Coefficient Loss ##############################################
...
def get_crf_img(inputs, outputs):
    for i in range(outputs.shape[0]):
        ...
        feats = create_pairwise_bilateral(
            sdims=(50, 50), schan=(20, 20, 20), img=img, chdim=2
        )
        d.addPairwiseEnergy(
            feats,
            compat=10,
...
# Some General Purpose Utilities functions
...
#################################### Printing the Progress bar during training ################################################
...
############################################## Logger function for training process ##################################################
