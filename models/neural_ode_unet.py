...
# Implementation of Neural ODE U-Net Model 

class NeuralODE_UNet(nn.Module):
    ...
    def forward(self, x):
        ...
        model = NeuralODE(UNet(params["in_channel"], class_num, drop_rate=params["drop_rate"]), sensitivity='adjoint', solver='rk4').to(device)
        return model
